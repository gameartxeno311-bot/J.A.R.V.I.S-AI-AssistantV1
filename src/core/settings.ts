...
export const DEFAULT_SETTINGS: AssistantConfig = {
  ...
  voiceEnabled: true, voiceName: '', voiceRate: 0.98, voicePitch: 0.92, voiceVolume: 1, voiceLanguage: 'en-US', customVoiceFileName: '', customVoiceUrl: '',
  llmAdapterEnabled: false, llmAdapterName: '', llmAdapterFileName: '', notificationsEnabled: true, soundEffectsEnabled: true, theme: 'red',
};
